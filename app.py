...
# --- 2. المؤقت المطور + صوت المطر المباشر ---
with tab_timer:
    ...
    st.divider()
    st.subheader("🌧️ أجواء التركيز (صوت المطر الهادئ)")
    st.write("شغّل الصوت ليزيد تركيزك ويمنع المشتتات أثناء الدراسة:")
    st.audio("https://cdn.pixabay.com/download/audio/2022/05/16/audio_db6591201e.mp3?filename=soft-rain-ambient-111154.mp3", format="audio/mp3")
...
with tab_spiritual:
    ...
    if "قبل الدراسة" in dua_option:
        ...
        with st.expander("✨ سورة يس كاملة (قلب القرآن)"):
            st.markdown("""
                <div class="quran-box" style="text-align: justify; font-size: 1.15rem; line-height: 2.5;">
                    ...
                    <i>(ملاحظة: تم تضمين مطلع السورة للتبسيط، ويتم توفير بقية الأجزاء ضمن مشغل قراءة سلس).</i>
                </div>
            """, unsafe_allow_html=True)

    elif "زيارة عاشوراء" in dua_option:
        st.write("### 📜 زيارة عاشوراء الشريفة")
        st.info("💡 قراءة زيارة عاشوراء تجلب السكينة والبركة والطمأنينة للنفس قبل وبعد المذاكرة.")
        
        with st.expander("✨ اضغط هنا لقراءة نص زيارة عاشوراء بالكامل", expanded=True):
            st.markdown("""
...
with tab_tips:
    ...
    elif "زيارة عاشوراء" in tip_category:
        st.write("### 📜 أهمية وأثر قراءة زيارة عاشوراء يومياً وأثناء فترة الدراسة")
        st.success("🌸 **1. طمأنينة النفس وراحة البال:** المداومة اليومية على زيارة عاشوراء تبث في القلب السكينة وتزيل الخوف والقلق المتزايد من الامتحانات والمواد الصعبة.")
        st.info("🧠 **2. صفاء الذهن والبرود العصبي:** تمنح الطالب ثباتاً انفعالياً وعصبياً أثناء المذاكرة، مما يقلل من التشتت والنسيان السريع.")
        st.warning("🕊️ **3. التوفيق والبركة في الوقت:** تجعل في وقت المذاكرة بركة وتسييراً كبيراً، بحيث يستوعب الطالب الحفظ والفهم في وقت أسرع وبمجهود أقل.")
        st.markdown("✨ **توصية:** اجعل قراءة الزيارة جزءاً من جدولك اليومي في الصباح قبل البدء بالمذاكرة أو عند الاستراحة لتجديد طاقتك الروحية.")
