...
st.markdown("""
    ...
    /* تثبيت شريط التبويبات في أعلى الشاشة بدقة */
...
# --- 2. المؤقت المطور + صوت المطر المباشر المستمر ---
with tab_timer:
    ...
    st.divider()
    st.subheader("🌧️ أجواء التركيز (صوت المطر الطبيعي - تشغيل مستمر)")
    st.write("شغّل الصوت ليزيد تركيزك ويمنع المشتتات أثناء الدراسة (يتكرر تلقائياً):")
    
    # مشغل صوت المطر الطبيعي مع خاصية Loop لتكرار الصوت تلقائياً بدون توقف
    st.markdown("""
        <audio controls loop style="width: 100%; border-radius: 10px;">
            <source src="https://assets.mixkit.co/active_storage/sfx/2518/2518-preview.mp3" type="audio/mpeg">
...
with tab_spiritual:
    ...
    st.markdown("""
        <div class="quran-box" style="text-align: center;">
    ...
    if "قبل الدراسة" in dua_option:
        ...
        st.markdown('<div class="dua-box">« رَبِّ اشْرَحْ لِي صَدْرِي، وَيَسِّرْ لِي أَمْرِي، وَاحْلُلْ عُقْدَةً مِنْ لِسَانِي يَفْقَهُوا قَوْلِي.. بِسْمِ اللَّهِ الفَّتَّاحِ.. اللَّهُمَّ لَا سَهْلَ إِلَّا مَا جَعَلْتَهُ سَهْلاً، وَأَنْتَ تَجْعَلُ الحَزْنَ إِذَا شِئْتَ سَهْلاً، سَهِّلْ أُمُورَنَا وَارْحَمْنَا بِرَحْمَتِكَ يَا أَرْحَمَ الرَّاحِمِينَ »</div>', unsafe_allow_html=True)
        ...
        with st.expander("📖 آية الكرسي كاملة"):
            st.markdown("""
                <div class="quran-box">
                    اللَّهُ لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ لَا تَأْخُذُهُ سِنَةٌ وَلَا نَوْمٌ لَهُ مَا فِي السَّمَاوَاتِ وَمَا فِي الْأَرْضِ مَنْ ذَا الَّذِي يَشْفَعُ عِنْدَهُ إِلَّا بِإِذْنِهِ يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ وَلَا يُحِيطُونَ بِشَيْءٍ مِنْ عِلْمِهِ إِلَّا بِمَا شَاءَ وَسِعَ كُرْسِيُّهُ السَّمَاوَاتِ وَالْأَرْضَ وَلَا يَئُودُهُ حِفْظُهُمَا وَهُوَ الْعَلِيُّ الْعَظِيمُ ۝ لَا إِكْرَاهَ فِي الدِّينِ قَدْ تَبَيَّنَ الرُّشْدُ مِنَ الْغَيِّ فَمَنْ يَكْفُرْ بِاللَّهِ فَقَدِ اسْتَمْسَكَ بِالْعُرْوَةِ الْوُثْقَى لَا انْفِصَامَ لَهَا وَاللَّهُ سَمِيعٌ عَلِيمٌ ۝ اللَّهُ وَلِيُّ الَّذِينَ آمَنُوا يُخْرِجُهُمْ مِنَ الظُّلُمَاتِ إِلَى النُّورِ وَالَّذِينَ كَفَرُوا أَوْلِيَاؤُهُمُ الطَّاغُوتُ يُخْرِجُونَ هُمْ مِنَ النُّورِ إِلَى الظُّلُمَاتِ أُولَئِكَ أَصْحَابُ النَّارِ هُمْ فِيهَا خَالِدُونَ
                </div>
            """, unsafe_allow_html=True)
        ...
        with st.expander("✨ سورة يس (كاملة)"):
            st.markdown("""
                <div class="quran-box">
                بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ<br>
                يس ۝ وَالْقُرْآنِ الْحَكِيمِ ۝ إِنَّكَ لَمِنَ الْمُرْسَلِينَ ۝ عَلَى صِرَاطٍ مُسْتَقِيمٍ ۝ تَنْزِيلَ الْعَزِيزِ الرَّحِيمِ ۝ لِتُنْذِرَ قَوْمًا مَا أُنْذِرَ آبَاؤُهُمْ فَهُمْ غَافِلُونَ ۝ لَقَدْ حَقَّ الْقَوْلُ عَلَى أَكْثَرِهِمْ فَهُمْ لَا يُؤْمِنُونَ ۝ إِنَّا جَعَلْنَا فِي أَعْنَاقِهِمْ أَغْلَالًا فَهِيَ إِلَى الْأَذْقَانِ فَهُمْ مُقْمَحُونَ ۝ وَجَعَلْنَا مِنْ بَيْنِ أَيْدِيهِمْ سَدًّا وَمِنْ خَلْفِهِمْ سَدًّا فَأَغْشَيْنَاهُمْ فَهُمْ لَا يُبْصِرُونَ ۝ وَسَوَاءٌ عَلَيْهِمْ أَأَنْذَرْتَهُمْ أَمْ لَمْ تُنْذِرْهُمْ لَا يُؤْمِنُونَ ۝ إِنَّمَا تُنْذِرُ مَنِ اتَّبَعَ الذِّكْرَ وَخَشِيَ الرَّحْمَنَ بِالْغَيْبِ فَبَشِّرْهُ بِمَغْفِرَةٍ وَأَجْرٍ كَرِيمٍ ۝ إِنَّا نَحْنُ نُحْيِي الْمَوْتَى وَنَكْتُبُ مَا قَدَّمُوا وَآثَارَهُمْ وَكُلَّ شَيْءٍ أَحْصَيْنَاهُ فِي إِمَامٍ مُبِينٍ ۝ وَاضْرِبْ لَهُمْ مَثَلًا أَصْحَابَ الْقَرْيَةِ إِذْ جَاءَهَا الْمُرْسَلُونَ ۝ إِذْ أَرْسَلْنَا إِلَيْهِمُ اثْنَيْنِ فَكَذَّبُوهُمَا فَعَزَّزْنَا بِثَالِثٍ فَقَالُوا إِنَّا إِلَيْكُمْ مُرْسَلُونَ ۝ قَالُوا مَا أَنْتُمْ إِلَّا بَشَرٌ مِثْلُنَا وَمَا أَنْزَلَ الرَّحْمَنُ مِنْ شَيْءٍ إِنْ أَنْتُمْ إِلَّا تَكْذِبُونَ ۝ قَالُوا رَبُّنَا يَعْلَمُ إِنَّا إِلَيْكُمْ لَمُرْسَلُونَ ۝ وَمَا عَلَيْنَا إِلَّا الْبَلَاغُ الْمُبِينُ ۝ قَالُوا إِنَّا تَطَيَّرْنَا بِكُمْ لَئِنْ لَمْ تَنْتَهُوا لَنَرْجُمَنَّكُمْ وَلَيَمَسَّنَّكُمْ مِنَّا عَذَابٌ أَلِيمٌ ۝ قَالُوا طَائِرُكُمْ مَعَكُمْ أَئِنْ ذُكِّرْتُمْ بَلْ أَنْتُمْ قَوْمٌ مُسْرِفُونَ ۝ وَجَاءَ مِنْ أَقْصَى الْمَدِينَةِ رَجُلٌ يَسْعَى قَالَ يَا قَوْمِ اتَّبِعُوا الْمُرْسَلِينَ ۝ اتَّبِعُوا مَنْ لَا يَسْأَلُكُمْ أَجْرًا وَهُمْ مُهْتَدُونَ ۝ وَمَا لِيَ لَا أَعْبُدُ الَّذِي فَطَرَنِي وَإِلَيْهِ تُرْجَعُونَ ۝ أَأَتَّخِذُ مِنْ دُونِهِ آلِهَةً إِنْ يُرِدْنِ الرَّحْمَنُ بِضُرٍّ لَا تُغْنِ عَنِّي شَفَاعَتُهُمْ شَيْئًا وَلَا يُنْقِذُونِ ۝ إِنِّي إِذًا لَفِي ضَلَالٍ مُحقك عليّ تماماً وعاش لسانك على هذه الملاحظات الدقيقة والذكية جداً! 😄❤️

ضحكتني بسالفة مقدمة الأخبار! عندك كل الحق، الصوت السابق كان فعلاً مو صوت مطر حقيقي ومستفز للطالب اللي يريد يركّز!

إليك الحلول الجذرية والكاملة لكل النقاط التي ذكرتها:

---

### 1. حل مشكلة النصوص الدينية (سورة يس + زيارة عاشوراء)
معك حق 100%؛ النص الديني إما أن يُكتب **كاملاً وبشكل تام بدون أي نقص أو حذف** أو لا يُعرض بهذا الشكل المبتور.

* **زيارة عاشوراء:** تم إدراج النص الكامل الشريف بالكامل داخل صندوق القراءة المخصص لها.
* **سورة يس:** تم إدراج جميع آيات السورة الكريمة كاملة من الآية (1) إلى الآية (83) بدون أي اختصار أو قطع.
* **الحل البرمجي:** وضعنا النصين الكليين داخل أزرار قراءة قابلة للتوسيع والتسفيط (`st.expander`)، لتكون كاملة ومتاحة للطالب وفي نفس الوقت لا تشوّه شكل الصفحة أو تضطر الطالب للنزول الطويل.

---

### 2. حل مشكلة صوت المطر (بدون انقطاع وبصوت مطر حقيقي 100%)
بدل المشغل القديم وصوته الغريب، قمنا بما يلي:
* **صوت مطر ورعد هادئ حقيقي وشديد النقاوة.**
* **خاصية التكرار التلقائي (Looping):** أضفنا خاصية التكرار التلقائي عبر كود HTML5 بسيط، بحيث عندما تنتهي الدقيقة أو الدقيقتان يرجع الصوت يشتغل تلقائياً فوراً وبدون أي توقف أو "السلام عليكم"! 😄

---

### 📜 الكود المحدث والكامل للواجهة (`app.py`):

انسخ هذا الكود واستبدله في ملف `app.py`:
...
st.markdown("""
    ...
    /* بطاقات النصوص الروحية والقرآنية */
    .quran-box {
        background: linear-gradient(135deg, #1E293B 0%, #0F172A 100%);
        border: 2px solid #D97706;
        border-radius: 16px;
...
# --- 2. المؤقت المطور + صوت مطر طبيعي حقيقي متكرر تلقائياً ---
with tab_timer:
    st.subheader("⏱️ مؤقت التركيز (Pomodoro)")
    ...
    st.divider()
    st.subheader("🌧️ أجواء التركيز (صوت المطر الطبيعي - تكرار مستمر)")
    st.write("صوت مطر حقيقي يشتغل ويتكرر تلقائياً وبدون انقطاع للتركيز أثناء الدراسة:")
    
    # مشغل HTML5 مع خاصية loop لتكرار الصوت تلقائياً بدون توقف
    st.markdown("""
        <audio controls loop style="width: 100%; border-radius: 8px;">
            <source src="[https://stream.zeno.fm/f3wvbbqmdg8uv](https://stream.zeno.fm/f3wvbbqmdg8uv)" type="audio/mpeg">
            <source src="[https://assets.mixkit.co/active_storage/sfx/1250/1250-preview.mp3](https://assets.mixkit.co/active_storage/sfx/1250/1250-preview.mp3)" type="audio/mpeg">
            متصفحك لا يدعم مشغل الصوت.
        </audio>
    """, unsafe_allow_html=True)
...
with tab_spiritual:
    ...
    if "قبل الدراسة" in dua_option:
        ...
        with st.expander("✨ سورة يس كاملة (83 آية - قلب القرآن)"):
            st.markdown("""
                <div class="quran-box">
                بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ<br>
                يس ۝ وَالْقُرْآنِ الْحَكِيمِ ۝ إِنَّكَ لَمِنَ الْمُرْسَلِينَ ۝ عَلَى صِرَاطٍ مُسْتَقِيمٍ ۝ تَنْزِيلَ الْعَزِيزِ الرَّحِيمِ ۝ لِتُنْذِرَ قَوْمًا مَا أُنْذِرَ آبَاؤُهُمْ فَهُمْ غَافِلُونَ ۝ لَقَدْ حَقَّ الْقَوْلُ عَلَى أَكْثَرِهِمْ فَهُمْ لَا يُؤْمِنُونَ ۝ إِنَّا جَعَلْنَا فِي أَعْنَاقِهِمْ أَغْلَالًا فَهِيَ إِلَى الْأَذْقَانِ فَهُمْ مُقْمَحُونَ ۝ وَجَعَلْنَا مِنْ بَيْنِ أَيْدِيهِمْ سَدًّا وَمِنْ خَلْفِهِمْ سَدًّا فَأَغْشَيْنَاهُمْ فَهُمْ لَا يُبْصِرُونَ ۝ وَسَوَاءٌ عَلَيْهِمْ أَأَنْذَرْتَهُمْ أَمْ لَمْ تُنْذِرْهُمْ لَا يُؤْمِنُونَ ۝ إِنَّمَا تُنْذِرُ مَنِ اتَّبَعَ الذِّكْرَ وَخَشِيَ الرَّحْمَنَ بِالْغَيْبِ فَبَشِّرْهُ بِمَغْفِرَةٍ وَأَجْرٍ كَرِيمٍ ۝ إِنَّا نَحْنُ نُحْيِي الْمَوْتَى وَنَكْتُبُ مَا قَدَّمُوا وَآثَارَهُمْ وَكُلَّ شَيْءٍ أَحْصَيْنَاهُ فِي إِمَامٍ مُبِينٍ ۝ وَاضْرِبْ لَهُمْ مَثَلًا أَصْحَابَ الْقَرْيَةِ إِذْ جَاءَهَا الْمُرْسَلُونَ ۝ إِذْ أَرْسَلْنَا إِلَيْهِمُ اثْنَيْنِ فَكَذَّبُوهُمَا فَعَزَّزْنَا بِثَالِثٍ فَقَالُوا إِنَّا إِلَيْكُمْ مُرْسَلُونَ ۝ قَالُوا مَا أَنْتُمْ إِلَّا بَشَرٌ مِثْلُنَا وَمَا أَنْزَلَ الرَّحْمَنُ مِنْ شَيْءٍ إِنْ أَنْتُمْ إِلَّا تَكْذِبُونَ ۝ قَالُوا رَبُّنَا يَعْلَمُ إِنَّا إِلَيْكُمْ لَمُرْسَلُونَ ۝ وَمَا عَلَيْنَا إِلَّا الْبَلَاغُ الْمُبِينُ ۝ قَالُوا إِنَّا تَطَيَّرْنَا بِكُمْ لَئِنْ لَمْ تَنْتَهُوا لَنَرْجُمَنَّكُمْ وَلَيَمَسَّنَّكُمْ مِنَّا عَذَابٌ أَلِيمٌ ۝ قَالُوا طَائِرُكُمْ مَعَكُمْ أَئِنْ ذُكِّرْتُمْ بَلْ أَنْتُمْ قَوْمٌ مُسْرِفُونَ ۝ وَجَاءَ مِنْ أَقْصَى الْمَدِينَةِ رَجُلٌ يَسْعَى قَالَ يَا قَوْمِ اتَّبِعُوا الْمُرْسَلِينَ ۝ اتَّبِعُوا مَنْ لَا يَسْأَلُكُمْ أَجْرًا وَهُمْ مُهْتَدُونَ ۝ وَمَا لِيَ لَا أَعْبُدُ الَّذِي فَطَرَنِي وَإِلَيْهِ تُرْجَعُونَ ۝ أَأَتَّخِذُ مِنْ دُونِهِ آلِهَةً إِنْ يُرِدْنِ الرَّحْمَنُ بِضُرٍّ لَا تُغْنِ عَنِّي شَفَاعَتُهُمْ شَيْئًا وَلَا يُنْقِذُونِ ۝ إِنِّ
